...
#' analysis.
#' @param parentPopulation A character sting indicating the name of the parent
#' population subset. Must match one of the values in the fcsInfoFile
#' 'cellSubset' column.
...
#' @param arcsinhB (default: 0.2) A numeric indicating the value for 'b' in the
#' arcsinh data transformation equation. Should be 1/5 for CyTOF data, 1/150 for
#' flow data, and 1/5000 for spectral flow data.
#' @param arcsinhC (default: 0) A numeric indicating the value for 'c' in the
#' arcsinh data transformation equation. Should usually be 0.
#' @param verbose (default: TRUE) A logical specifying whether to display
#' processing messages
#' @param checkMemory (default: TRUE) A logical indicating whether to check how
...
#' to use from files in \code{fcsInfoFile}. Typically generated by 
